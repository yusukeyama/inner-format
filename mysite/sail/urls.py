...
from sail import views

app_name = 'sail'
urlpatterns = [
    # トップページ
    path('', views.index, name='index'), #トップ
    path('profile/', views.profile, name='profile'), #プロフィール
    # 書籍
    ...
    path('impression/del/<int:book_id>/<int:impression_id>/', views.impression_del, name='impression_del'),  # 修正
]